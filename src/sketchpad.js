 ...
 * new programmers a simple API to experiment with the JavaScript.
 *
 * WARNING!
 ...
 * Sketchpad only supports one Canvas element at the time.
 ...
 *
 * WHAT CAN YOU DO WITH SKETCHPAD?
 * - Draw shapes (via HTML5 canvas element)
 * - Structure your code
 * - Create animations
 * - Use Keyboard and Mouse input
 * - Dynamically create input sliders for your variables (cool)
 *
 * You find the fill API at: ...
 *
 * @version: 0.5
 */
